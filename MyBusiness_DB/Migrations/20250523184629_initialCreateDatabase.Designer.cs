...
namespace MyBusiness_DB.Migrations
{
    ...
    [Migration("20250523184629_initialCreateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBusiness_DB.Models.Product", b =>
                {
                    ...
                    b.Property<int?>("UnitOfMeasurementUnitMId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UnitOfMeasurementUnitMId");
            ...
            modelBuilder.Entity("MyBusiness_DB.Models.UnitOfMeasurement", b =>
                {
                    b.Property<int>("UnitMId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("UnitMId"));

                    b.Property<string>("UnitMName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("UnitMUnitOfMeasure")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MyBusiness_DB.Models.Product", b =>
                {
                    ...
                    b.HasOne("MyBusiness_DB.Models.UnitOfMeasurement", null)
                        .WithMany("Products")
                        .HasForeignKey("UnitOfMeasurementUnitMId");
                });
